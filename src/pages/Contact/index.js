...
const Contact = () => {
  ...
  const sendEmail = (event) => {
    ...
    send('service_y8icbfd', 'template_lq9fd3j', {
        ...
        from_subject: event.target.subject.value,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        ...
        >
          ...
          <div className="flex items-center my-6">
            ...
            <h3 className="font-medium text-primary">Chinthamani G</h3>
          </div>
          <div className="flex items-center my-6">
            <FaPhoneAlt className="text-2xl mr-8 hover:text-primary cursor-pointer duration-300"></FaPhoneAlt>
            <h3 className="font-medium text-primary">+91 9842974450</h3>
          </div>
          <div className="flex items-center my-6">
            <MdEmail className="text-2xl mr-8 hover:text-primary cursor-pointer duration-300"></MdEmail>
            <h3 className="font-medium text-primary">chinthamani2525@gmail.com</h3>
          </div>
          <div className="flex items-center my-6">
